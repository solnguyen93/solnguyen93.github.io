...
const submitForm = document.querySelector('#submit-story-form');
const myStoriesList = document.querySelector('#my-stories-list');
const allStoriesList = document.querySelector('#all-stories-list');
const favoritesList = document.querySelector('#my-favorites-list');
const $myStoriesList = $('#my-stories-list');
const $favoritesList = $('#my-favorites-list');
const $storiesContainer = $('#stories-container container');
const allOl = document.querySelector('.stories-container');
...
function hidePageComponents() {
    ...
    myStoriesList.style.display = 'none';
}
